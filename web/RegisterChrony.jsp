    ...
    <div class="content_resize">
      <div class="mainbar">
        ...
        <div class="article">
          ...
          <form action="regchrony" method="post" id="">
            <ol>
              <li>
                <label>First Name</label>
                <input type="Fname" name="fname" value="" class="text"/>
              </li>
              <li>
                <label>Last Name</label>
                <input type="Lname" name="lname" value="" class="text" />
              </li>
                <li>
                ...
                <input type="text" name="pod" value=""  id="datepicker"/>
              </li>
                
              
                 <li>
                <label>Chrony ID</label>
                <input type="text" name="chserial" value="" class="text"/>
              </li>
                ...
                <label>Contact Number</label>
                 <input type="text" name="phone" id="phone" class="text" onblur=""/>
             ...
             <li>
                ...
                <input type="password" name="pass" value="" class="text"/>
                 ...
                 <li>
                <label>Re-type Password (required)</label>
                <input type="password" name="repass" value="" class="text"/>
                 </li>
                <li>
                <label>Select Chrony type</label>
                <select name="chtype">
                    <option value='unknown'>select</option>
                    
                    <option value='One'>Basic Chrony</option>
                    <option value='Two'>Chrony with Glass</option>
