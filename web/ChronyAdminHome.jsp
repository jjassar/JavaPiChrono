...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="slider">
        <div id="coin-slider"> 
            <a href="#"><img src="images/slide1.jpg" width="940" height="310" alt="" /> 
            </a> <a href="#"><img src="images/slide2.jpg" width="940" height="310" alt="" /> </a> 
      ...
      <div class="menu_nav">
        <ul>
          ...
          <li><a href="index.html" onclick="return dsb()"><span>Logout</span></a></li>
        </ul>
      </div>
      <div class="clr"></div>
    </div>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>View Chrony Database </span><%=session.getAttribute("username")%>
          </h2>
          <div class="clr"></div>
       </div>
        <div class="article">
          ...
          <style>
            ...
            int j=2;
               ...
               ResultSet rs= stmt.executeQuery("select * from velrecords where chserial='"+session.getAttribute("cn")+"'");
              while(rs.next())
              {
              i++;
                  if(j%2==0)
  ...
  <div class="fbg">
    <div class="fbg_resize">
      <div class="col c1">
        ...
        <a href="#"><img src="images/emp.jpg" width="75" height="75" alt="" class="gal" /></a> 
        <a href="#"><img src="images/emp2.png" width="75" height="75" alt="" class="gal" /></a> 
        <a href="#"><img src="images/emp3.gif" width="75" height="75" alt="" class="gal" /></a> 
        <a href="#"><img src="images/emp4.png" width="75" height="75" alt="" class="gal" /></a> 
        <a href="#"><img src="images/emp5.png" width="75" height="75" alt="" class="gal" /></a> 
        <a href="#"><img src="images/emp6.png" width="75" height="75" alt="" class="gal" /></a> </div>
      <div class="col c2">
