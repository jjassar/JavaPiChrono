    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
            ...
            <h1>Your unique chrony no is </h1><h2 style="color:#cd0a0a"><%=session.getAttribute("chser")%> </h2>
            <h1>Chrony is registered with mail address </h1><h2 style="text-transform:lowercase;color:#cd0a0a"><%=session.getAttribute("name")%> </h2>
            </table>
          <div class="clr"></div>
       </div>
        <div class="article">
